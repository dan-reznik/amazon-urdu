...
- Play with PCA (initial tests did not help), and other kinds (non-linear) of dimensionality reduction, see picture below
- Play with TF*IDF on document term matrix (initial tests were not good)
- DO high  with other classification algos
